...
class ControllerTest {
  ...
  given()
   ...
   given()
            .when()
            .get("/ExclusiveAccess/Projects?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/ExclusiveAccess/Projects/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM ExclusiveAccess.Project");
